...
if __name__ == '__main__':
    ...
    parser.add_argument('--img', default="assets/pano_aabrsshujmskyq.png",
                        help='Image texture in equirectangular format')
    parser.add_argument('--layout', default="assets/pano_aabrsshujmskyq.png.json",
    ...
    args.img = "assets/16-47-04.jpg"
    args.layout  = "assets/16-47-04.layout.txt"
    ...
    equirect_texture = cv2.resize(equirect_texture, (1024, 512), interpolation=cv2.INTER_LINEAR)
